...
const LiveTicketFeed = () => {
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-0 overflow-hidden h-full flex flex-col scrollbar-thin">
      <div className="p-5 border-b border-slate-100 dark:border-slate-700 flex flex-col md:flex-row justify-between items-center bg-slate-50 dark:bg-slate-900/50">
        ...
        {recentTickets.map((ticket, idx) => (
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start mb-1">
              ...
              <span className="text-xs flex mt-1 md:mt-0 text-slate-500 dark:text-slate-400 items-center gap-1">
                <FiClock size={10} /> {ticket.time}
              </span>
            </div>
            <h4
              className={`text-sm font-semibold mt-4 md:mt-0 ${
            ...
            <div className="flex items-center gap-1 mt-1 text-xs text-slate-600 dark:text-slate-400 group-hover:text-[#053F5C] dark:group-hover:text-white transition-colors">
